...
pub const SOURCE_ACCOUNTING: &[OrganizationAccountingEntry] = &[
    ...
    OrganizationAccountingEntry {
        id: "history-rows-and-opaque-payloads",
        upstream_path: "src/common/database.c;src/common/history.c",
        upstream_symbols: "main.history;op_params/blendop_params",
        rust_owner: "rusttable-compat::CompatHistoryStep",
        status: "replaced",
    },
    OrganizationAccountingEntry {
        id: "history-end-and-hash-state",
        upstream_path: "src/common/database.c;src/common/history.c",
        upstream_symbols: "images.history_end;main.history_hash",
        rust_owner: "rusttable-compat::HistorySelection/CompatHistoryHash",
        status: "replaced",
    },
    OrganizationAccountingEntry {
        id: "module-instances",
        upstream_path: "src/develop/imageop.h;src/common/history.c",
        upstream_symbols: "multi_priority;multi_name;instance matching",
        rust_owner: "rusttable-compat::CompatModuleInstance",
        status: "replaced",
    },
    OrganizationAccountingEntry {
        id: "module-order-records",
        upstream_path: "src/common/database.c;src/common/iop_order.c",
        upstream_symbols: "main.module_order;serialized iop_list",
        rust_owner: "rusttable-compat::CompatModuleOrder",
        status: "replaced",
    },
    OrganizationAccountingEntry {
        id: "operation-manifest-validation",
        upstream_path: "src/iop/iop_api.h;src/common/iop_order.c",
        upstream_symbols: "operation compatibility/version/order manifest",
        rust_owner: "rusttable-compat::DarktableOperationManifest",
        status: "replaced",
    },
    OrganizationAccountingEntry {
        id: "history-order-proof",
        upstream_path: "src/common/history.c;src/common/iop_order.c",
        upstream_symbols: "history num;module-order rules;selected/redo partition",
        rust_owner: "rusttable-compat::HistoryDecoder",
        status: "replaced",
    },
];
