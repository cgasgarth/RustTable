...
pub enum FindingCode {
    ...
    InvalidHistoryNumber,
    DuplicateHistoryNumber,
    HistoryNumberGap,
    InvalidEnabled,
    InvalidMultiPriority,
    InvalidMultiName,
    DuplicateInstanceKey,
    MultipleHistoryEndpoints,
    InvalidHistoryEnd,
    MissingHistoryEnd,
    InvalidModuleOrderVersion,
    InvalidModuleOrderList,
    DuplicateModuleOrderEntry,
    MissingModuleOrderEntry,
    ModuleOrderConflict,
    UnknownModuleOrderOperation,
    MultipleModuleOrderRows,
    MissingHistoryHash,
    HistoryHashMismatch,
    MultipleHistoryHashRows,
    HistoryPayloadLimit,
    HistoryRowLimit,
    HistoryNameLimit,
    HistoryOrderLimit,
