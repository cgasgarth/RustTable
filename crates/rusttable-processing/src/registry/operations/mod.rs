...
mod censorize;
pub use censorize::censorize_definition;
mod clahe;
pub use clahe::clahe_definition;
mod defringe;
pub use defringe::defringe_definition;
mod clipping;
mod liquify;
mod rasterfile;
use super::{
...
pub use rasterfile::rasterfile_definition;
...
macro_rules! builtin_operations {
    () => {
        &[
            ...
            $crate::registry::reconstruction::highlights_definition,
            $crate::registry::reconstruction::color_reconstruction_definition,
