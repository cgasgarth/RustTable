...
pub use registry_operations::{
    ...
    finalscale_definition, flip_definition, linear_offset_definition, rgb_gain_definition,
    rotatepixels_definition, scalepixels_definition, temperature_definition,
};
