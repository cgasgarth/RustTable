...
#[path = "descriptor_basicadj.rs"]
mod descriptor_basicadj;
pub use descriptor_basicadj::basicadj_descriptor;
...
#[path = "descriptor_clahe.rs"]
mod descriptor_clahe;
...
pub use descriptor_clahe::clahe_descriptor;
