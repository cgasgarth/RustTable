...
pub(super) fn run(
    ...
    match command {
        ...
        _ => Err("issue-spec commands must be dispatched by the issue-spec surface".to_owned()),
    }
}
...
#[path = "github_api.rs"]
mod github_api;
pub(super) use github_api::{FixtureApi, GitHubApi, apply_issue_spec_updates, issue_spec_values};
